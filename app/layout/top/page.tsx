export default function Home() {
  return (
    <div className="not-prose overflow-auto rounded-lg bg-cyan-50 outline outline-white/5 dark:bg-gray-950/50 p-8 space-y-10">
      <div className="grid grid-cols-3 grid-rows-3 place-items-center gap-4 font-mono text-sm leading-6 font-bold text-white">
        ...
        <div className="relative size-18 rounded-lg sm:size-32">
          ...
          <div className="absolute inset-0 flex items-center justify-center rounded-lg bg-purple-500 p-4">
            05
          </div>
        </div>
        <div className="relative size-18 rounded-lg sm:size-32">
